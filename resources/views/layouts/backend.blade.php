...
<head>
    ...
    <title>{{ ucfirst($userRole) }} - {{ config('app.name') }}</title>
        ...
        <nav id="sidebar" aria-label="Main Navigation">
            ...
            <div class="content-header">
                ...
                <a class="font-semibold text-dual" href="/">
                    ...
                    <span class="smini-hide fs-5 tracking-wider">{{ $userRole . ' Panel' }}</span></span>
                </a>
                <!-- END Logo -->
                    ...
                    <ul class="nav-main">
                        ...
                        @if (auth()->user()->hasRole('admin'))
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->segment(1) == 'admin' && request()->segment(2) == null ? ' active' : '' }}"
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->segment(2) == 'events' ? ' active' : '' }}"
                        ...
                        @if (auth()->user()->hasRole('host'))
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->segment(1) == 'host' && request()->segment(2) == null  ? ' active' : '' }}"
                                    href="{{ route('host.dashboard.host') }}">
                                    <i class="nav-main-link-icon si si-cursor"></i>
                                    <span class="nav-main-link-name">Dashboard</span>
                                </a>
                            </li>
