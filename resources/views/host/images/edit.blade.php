...
@section('content')
    ...
    <div class="content content-boxed">
        ...
        <div class="block block-rounded">
            <form action="{{ route('host.images.update', $eventImage->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="block-header block-header-default d-flex align-items-center">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{ route('host.images.index') }}" class="mt-2 btn btn-sm btn-primary">All Images</a>
